%{?scl:%scl_package libev}

%global source_dir  %{_datadir}/%{name}-source
%global inst_srcdir %{buildroot}/%{source_dir}

Name:             %{?scl:%scl_prefix}libev
Summary:          High-performance event loop/event model with lots of features
Version:          4.15
Release:          6%{?dist}
License:          BSD or GPLv2+
URL:              http://software.schmorp.de/pkg/libev.html
Source0:          http://dist.schmorp.de/libev/Attic/libev-%{version}.tar.gz
...
Patch2:           libev-4.15-passenger40-soname.patch
...
LDFLAGS="-release passenger40"; export LDFLAGS;
make %{?_smp_mflags}
...
rm -rf %{buildroot}%{_libdir}/libev.la
...
%changelog
* Tue Jan 27 2015 Jan Kaluza <jkaluza@redhat.com> - 4.15-6
